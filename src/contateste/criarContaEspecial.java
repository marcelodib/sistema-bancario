...
public class criarContaEspecial extends JFrame{
    ...
    public criarContaEspecial(){
        ...
        texto4 = new JTextField("Limite de Credito", 12);
        add(texto4);
        ...
        public void actionPerformed(ActionEvent event){
            if(event.getSource() == button1){
                ...
                try {
                    ...
                    if(conta == null)
                    banco.criarContaEspecial(Integer.parseInt(numConta), nome, Float.parseFloat(saldo), Float.parseFloat(limite));
                    else{
            ...
            criarContaEspecial.this.dispose();
        }
    }
}
